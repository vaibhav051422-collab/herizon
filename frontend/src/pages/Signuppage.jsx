    ...
    <div className="flex justify-center items-center min-h-screen bg-[#050505] font-sans relative overflow-hidden px-6 py-12">
      ...
      >
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xs text-gray-500 uppercase tracking-[0.4em] font-bold">Join the Resilience Network</p>
        </div>

        {/* Role Selector */}
        <div className="space-y-4">
          <label className="block text-[11px] font-bold text-white/40 uppercase tracking-widest ml-6">Specify Network Role</label>
        ...
        <form onSubmit={handleSignup} className="space-y-10">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="block text-[11px] font-bold text-white/40 uppercase tracking-widest ml-8">Legal Name</label>
              <div className="relative group">
                <User className="absolute left-8 top-1/2 -translate-y-1/2 h-6 w-6 text-white/20 group-focus-within:text-[#FA9021] transition-colors" />
                <input
                  id="name"
                  type="text"
                  value={name}
            ...
            {/* Email */}
            <div className="space-y-3">
              <label className="block text-[11px] font-bold text-white/40 uppercase tracking-widest ml-8">Email Coordinate</label>
              <div className="relative group">
        ...
        <div className="text-center pt-6 border-t border-white/5">
          <p className="text-[11px] font-bold uppercase tracking-[0.3em] text-gray-500">
            Existing Node?{" "}
            <button
